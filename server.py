...
while True:
    ...
    for notified_socket in read_sockets:
        ...
        if notified_socket == server_socket:
            ...
            client_socket.send(bytes("Bem vindo à casa de leilões.\n", "utf-8"))
            client_socket.send(bytes("Digite (1) para vendedor, ou (2) para comprador", "utf-8"))
        # Else existing socket is sending a message
            ...
            # if (f'{message["data"].decode("utf-8")}' == 'teste'):
            #     print('string bateu!')
